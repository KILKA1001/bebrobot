...
SHOP_TEXT_CATEGORIES_HINT = "Что дальше: выберите категорию кнопкой ниже."
SHOP_TEXT_LIST_HINT = "Что дальше: выберите роль, чтобы открыть карточку."
SHOP_TEXT_CARD_HINT = "Что дальше: проверьте условия и нажмите «Купить»."
SHOP_TEXT_CONFIRM_PURCHASE = "⚠️ Что дальше: нажмите «Подтвердить покупку», чтобы завершить покупку."
...
SHOP_TEXT_PROTECTED_FAILURE = "Не получилось открыть экран. Что дальше: нажмите «Обновить» или вернитесь в категории."
...
SHOP_TEXT_ITEM_NOT_FOUND = "Этот товар не найден. Что дальше: нажмите «Обновить» и выберите роль снова."
