...
_REP_HELP_LINE = "/rep — основная точка входа в модерацию: лучше reply/@username для цели, нарушение выбирается кнопками, наказание считается автоматически по типу нарушения и числу предупреждений, а следующий шаг эскалации показывается ещё до подтверждения"
