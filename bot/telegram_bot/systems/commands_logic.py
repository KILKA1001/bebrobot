...
_REP_HELP_LINE = "/rep — основная точка входа в модерацию: выбери цель через reply/@username, выбери нарушение кнопками, проверь preview с предупреждениями и следующим шагом эскалации; наказание вручную вводить не нужно, бот берёт его из правил БД"
