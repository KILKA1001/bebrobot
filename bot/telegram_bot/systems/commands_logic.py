...
_PUBLIC_HELP_COMMANDS: tuple[str, ...] = (
    ...
    "/modstatus — единый статус по модерации: активные наказания, предупреждения, последние кейсы и legacy-штрафы.",
...
_MODSTATUS_HELP_LINE = "/modstatus — показать свои активные наказания, предупреждения, последние кейсы и legacy-штрафы; legacy-штрафы оплачиваются кнопкой прямо в этом экране"
