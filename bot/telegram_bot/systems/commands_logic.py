...
_PUBLIC_HELP_COMMANDS: tuple[str, ...] = (
    ...
    "/modstatus [reply] — единый статус по модерации: активные наказания, предупреждения, последние кейсы и legacy-штрафы.",
    "/myfines — открыть список своих legacy-штрафов и перейти к оплате прямо из интерфейса.",
