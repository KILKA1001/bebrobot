...
- `/rep` - Основная точка входа в модерацию: кейс, автонаказание, предупреждения, активный статус, история нарушений и штраф в банк, если он был частью кейса
- `/myfines` - Просмотреть свои активные legacy-штрафы, если старые денежные штрафы ещё остались на переходный период
- `/payfine ID_штрафа` - Оплатить legacy-штраф

### Администрирование
- `/fine @user сумма тип причина` - Legacy-команда совместимости для денежного штрафа; новые сценарии модерации начинаются с `/rep`, а не с monthly-top
