...
def _split_roles(roles: list[dict[str, str | None]]) -> tuple[list[dict[str, str | None]], list[dict[str, str | None]]]:
...
@app.get("/admin/api/users/<provider>/<provider_user_id>")
...
@app.get("/admin/api/users/<provider>/<provider_user_id>/roles/external")
...
@app.post("/admin/api/users/<provider>/<provider_user_id>/roles/custom")
...
@app.get("/admin/users/<provider>/<provider_user_id>/roles")
